...
def calc_sum(end):#매개변수 #타입/리턴타입 없음
    sum = 0
...
#함수의 호출
print(f'함수의 호출 결과: {calc_sum(100)}') #인수
...
#리턴이 있는 함수는 다른 함수의 매개값으로도 사용이 가능
print(add(add(5,7), add(9,8))) #add(12, 17)

n = int(input('정수: '))

def operate_all(n1, n2):
    return n1 + n2, n1 - n2, n1 * n2, n1 / n2 #tuple로 동시 선언
    #return n1 - n2
    #return n1 * n2
    #return n1 / n2

print(type(operate_all))

def multi(n1, n2):
    reslut = n1 * n2
    print(f'{n1} x {n2} = {reslut}')
