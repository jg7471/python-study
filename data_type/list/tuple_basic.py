...
print(f'총점: {sum}점, 평균: {sum/len(points):0.1f}점') #len 전역 변수

#튜플을 만들 때는 ()를 생략할 수 있음
print('-' * 40)
tu = 1, 3, 5, 7, 9
print(type(tu))

#튜플은 리스트와 마찬가지로 unpackaging이 가능
n1, n2, n3, n4, n5 = tu
print(n1, n2, n3, n4, n5)

#튜플로 가능한 문법(내부 요소값을 바꾸지 않는 행위) #원본은 변하지 않음
print(tu[2])
print(tu[1:3])
print(tu + (10, 11)) #추가
print(tu * 2)
...
p = tuple(p) #튜프롤 변경 : 데이터 변경 불가
# p[1] = 6 (x) 튜플에서는 값의 변경이 불가능

p = list(p) #리스트로 변경 :추가/변경 가능
